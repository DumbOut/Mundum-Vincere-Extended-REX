Recolor this Rome: Total War unit texture atlas only. This is a game texture, not concept art.

Input Colors Radius:

primary_colour				red 115, green 75, blue 40
secondary_colour			red 0, green 0, blue 0



Objective:
Replace ONLY existing Dacian faction color on clothing, cloth trim, shields, horse cloth, banners, painted leather, and other faction-colored elements with the exact RGB value:
...
Keep the alpha background and keep the file name, no random names!
