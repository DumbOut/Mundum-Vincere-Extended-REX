...
dcl_normal0 v3
dcl_texcoord0 v4
#line 4 "fleximesh1_addlight2.vsh"
; -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
; v0 = position
; v1 = blend weights
; v2 = blend indices
...
; -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
#line 31 "fleximesh1_addlight2.vsh"
mul r8, v2.zyxw, c[0].wwww
#line 35 "fleximesh1_addlight2.vsh"
dp3 r0.w, v1.xyz,	c[0].xzz; 
add r0.w, -r0.w, c[0].x
#line 39 "fleximesh1_addlight2.vsh"
mov a0.x, r8.x
...
mov r5.w, c[0].z
#line 52 "fleximesh1_addlight2.vsh"
mul r4, r4, v1.xxxx
mul r5, r5, v1.xxxx
#line 56 "fleximesh1_addlight2.vsh"
mov r9.x, c[a0.x + 24 + 0].w
mov r9.y, c[a0.x + 24 + 1].w
mov r9.z, c[a0.x + 24 + 2].w
mov r9.w, c[0].z
#line 62 "fleximesh1_addlight2.vsh"
mov a0.x, r8.y
...
mov r3.w, c[0].z
#line 74 "fleximesh1_addlight2.vsh"
mad r4, r2, r0.wwww, r4
mad r5, r3, r0.wwww, r5
#line 78 "fleximesh1_addlight2.vsh"
add r4, r4, r9
#line 81 "fleximesh1_addlight2.vsh"
m4x4 r6, r4, c[2]
mov oPos, r6
...
#line 86 "fleximesh1_addlight2.vsh"
