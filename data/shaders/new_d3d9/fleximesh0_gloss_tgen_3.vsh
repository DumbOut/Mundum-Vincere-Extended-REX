...
dcl_normal0 v3
dcl_texcoord0 v4
#line 5 "src\\game\\shaders\\fleximesh0.vsh"
mul r0, v2.zyxw, c[0].wwww
#line 8 "src\\game\\shaders\\fleximesh0.vsh"
mov a0.x, r0.x
...
mov r5.w, c[0].z
#line 20 "src\\game\\shaders\\fleximesh0.vsh"
m4x4 r6, r4, c[2]
mov oPos, r6
...
#line 25 "src\\game\\shaders\\fleximesh0.vsh"
...
add oT1, r3, -r1
mov oT1.w, c[0].x
#line 6 "src\\game\\shaders\\fleximesh0_gloss.vsh"
mov oT2, v4
#line 3 "src\\game\\shaders\\fleximesh0_gloss_tgen_1.vsh"
; Relies on world space position being in r4
mov oT3, v4
m4x3 oT4, r4, c[11] ; generate world space coordinate.
#line 3 "src\\game\\shaders\\fleximesh0_gloss_tgen_2.vsh"
